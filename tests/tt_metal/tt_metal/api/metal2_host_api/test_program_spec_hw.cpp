...
// Negative control: same kernel with the wait_min/down removed. UNPACK unpacks the ring slot immediately
// after the input tile, before PACK has written it, so the output must NOT equal the input. If this passes
